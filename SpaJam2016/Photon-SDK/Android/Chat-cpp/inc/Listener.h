...
namespace ExitGames
{
	namespace Chat
	{
		...
		public:
			...
			/** 
				Result of subscribe operation. Returns per channel name if the channel is now subscribed.
				@param channels channel names
				@param per channel result: true if subscribed*/
			...
			/**
				...
				@param name sender user who sent this message
				@param name message message it self
				@param name channelName channel name for private messages (messages you sent yourself get added to a channel per target username)*/
