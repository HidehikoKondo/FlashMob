...
namespace ExitGames
{
	...
	{
		/**
			Only in use as long as PhotonPeer.getTrafficStatsEnabled() == true;*/
		...
		public:
	        ...
	        int getLongestMessageCallback(void) const;
	        int getLongestRawMessageCallback(void) const;
		...
		protected:
	        ...
	        int mLongestMessageCallback;
	        int mLongestRawMessageCallback;
