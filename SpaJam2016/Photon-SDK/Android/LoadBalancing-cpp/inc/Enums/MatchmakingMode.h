...
namespace ExitGames
{
	namespace LoadBalancing
	{
		...
		namespace MatchmakingMode
		{
			...
			static const nByte SERIAL_MATCHING = 1; ///<Distributes players across available rooms sequentially but takes filter into account. Without filter, rooms get players evenly distributed.
