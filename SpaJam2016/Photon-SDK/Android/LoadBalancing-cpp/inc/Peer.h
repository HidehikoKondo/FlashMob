...
namespace ExitGames
{
	namespace LoadBalancing
	{
		...
		public:
			...
			{
				return opWebRpc(uriPath, Common::Helpers::ValueToObject::get(pParameterArray, arrSize));
			}
			...
			{
				return opWebRpc(uriPath, Common::Helpers::ValueToObject::get(pParameterArray, pArrSizes));
			}
