...
- (bool) connect:(EGAuthenticationValues*)authenticationValues :(NSString* const)nameServerAddress
{
	...
	if([mPeer connect:[NSString stringWithFormat:@"%@%@", nameServerAddress, [nameServerAddress containsString:@":"]?@"":[NSString stringWithFormat:@":%d", (mConnectionProtocol==ConnectionProtocol::UDP?NetworkPort::UDP:NetworkPort::TCP)+NAMESERVER_PORT_GAP]] :mAppIDPeerInit])
	{
