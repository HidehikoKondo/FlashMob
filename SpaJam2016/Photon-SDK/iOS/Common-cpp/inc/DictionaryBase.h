...
namespace ExitGames
{
	namespace Common
	{
		...
		protected:
			...
			template<typename FKeyType, typename FValueType> void put(const FKeyType& key, FValueType pVal, typename Common::Helpers::ArrayLengthType<FValueType>::type size);
			template<typename FKeyType, typename FValueType> void put(const FKeyType& key, FValueType pVal, const short* sizes);
