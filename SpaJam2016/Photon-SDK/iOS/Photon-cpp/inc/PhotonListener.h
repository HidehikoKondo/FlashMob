	...
	namespace Photon
	{
		...
		public:
			 ...
			 * SC_DISCONNECT the connection was closed (due to an API-call or a timeout)
			 ...
			 Furthermore this function will be called by Photon to inform about connection errors and warnings. Check PhotonConstants for a list (they start with SC_).
			...
			/**
			 ...
			 @param address the address, which has been pinged\endlink
			 @param pingResult the time in ms\endlink
			 @sa
			 @link PhotonPeer::pingServer()*/
